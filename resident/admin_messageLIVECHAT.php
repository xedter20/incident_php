...
if (isset($_POST['userUNIQUEid_receiver'])) {
    ...
    $results = $db->Select_Admin_OnChat($uniqueId_receiver);
}
?>
    ...
    $messages = $db->showMessages_Admin_OnChat($senderId, $receiverId);
    ?>
           ...
           $(function(){
            var receiverId = <?php echo json_encode($receiverId); ?>;
             setInterval(function(){
              $.ajax({
                type: "POST",
                url: "adminLOAD_NewMessage.php", // Create a separate PHP file to check for new messages
