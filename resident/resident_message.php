                ...
                <div class="col-12 col-lg-5 col-xl-3 border-right">
                    <div class="px-4 d-none d-md-block">
                      ...
                      <?php
                        ...
                        $results = $db->SELECT_ALL_LOOP_resident_data($residentID);
...
<script>
  function loadConversation(user_uniqueId_receiver) {
    ...
    window.location.href = 'resident_message.php?userUNIQUEid_receiver=' + user_uniqueId_receiver;
  }
  ...
  function loadSelectedUserConversation() {
    ...
    if (user_uniqueId_receiver) {
      ...
      $.ajax({
        url: 'resident_messageLIVECHAT.php', // Replace with the actual URL to load conversation data
        method: 'POST',
        data: {
